...
from utils.dto import SubmissionDTO
...
def create_submission(submission_dto: SubmissionDTO, session: SessionDep):
...
def get_submission_quantity(session: SessionDep):
