...
<div class="stat-col">
<span class="ctag sm">INTERESSE</span>
<strong class="sv">Aberto</strong>
<span class="sn">Mostra o teu apoio à candidatura de Faro</span>
<a class="sc" href="#interesse">→ Apoiar</a>
</div>
</div>
</div>
...
<span class="badge btj">EXPOSIÇÃO</span>
</div>
<h4>Feira de Empresas</h4>
<p>Espaço de exposição dedicado a empresas e projetos da área tecnológica, onde os participantes podem conhecer soluções, iniciativas e inovação do setor.</p>
<div class="ac-foot"><svg fill="none" stroke="#5a7080" stroke-width="1.2" viewbox="0 0 16 16"><circle cx="8" cy="6" r="3"></circle><path d="M2 14c0-3 2.5-5 6-5s6 2 6 5"></path></svg><span>EXPOSIÇÃO TECNOLÓGICA</span></div>
</div>
<div class="ac" data-cat="tecnico">
<div class="ac-top">
...
<span class="badge btech">TÉCNICO</span>
</div>
<h4>Workshops</h4>
...
<span class="badge bacad">ACADÉMICO</span>
</div>
...
<span class="badge bsocial">SOCIAL</span>
</div>
...
<span class="badge bcomp">COMPETIÇÃO</span>
</div>
<h4>CTFs</h4>
...
<div class="sch-list">
<div class="sr"><span class="st">14:00</span><span class="si">Check-ins</span><span class="sb sb-checkin">CHECK-IN</span></div>
<div class="sr"><span class="st">18:00</span><span class="si">Sessão de Boas Vindas</span><span class="sb sb-welcome">BOAS-VINDAS</span></div>
<div class="sr"><span class="st">20:00</span><span class="si">Jantar/Arraial Académico</span><span class="sb sb-dinner">JANTAR</span></div>
</div>
</div>
<div class="sch-panel" id="sch-sexta" role="tabpanel">
<p class="sch-dl">SEXTA-FEIRA · 2 ABR</p>
<div class="sch-list">
<div class="sr"><span class="st">10:00</span><span class="si">Palestra + Workshops #1, #2 e #3</span><span class="sb sb-talkworkshop">PALESTRA / WORKSHOP</span></div>
<div class="sr"><span class="st">11:00</span><span class="si">Palestra</span><span class="sb sb-talk">PALESTRA</span></div>
<div class="sr"><span class="st">12:00</span><span class="si">Almoço</span><span class="sb sb-meal">REFEIÇÃO</span></div>
<div class="sr"><span class="st">14:00</span><span class="si">Palestra + Workshops #4, #5 e #6</span><span class="sb sb-talkworkshop">PALESTRA / WORKSHOP</span></div>
<div class="sr"><span class="st">15:00</span><span class="si">Palestra</span><span class="sb sb-talk">PALESTRA</span></div>
<div class="sr"><span class="st">16:30</span><span class="si">Coffee Break</span><span class="sb sb-network">NETWORKING</span></div>
<div class="sr"><span class="st">17:00</span><span class="si">Palestra</span><span class="sb sb-talk">PALESTRA</span></div>
<div class="sr"><span class="st">18:00</span><span class="si">Tertúlia</span><span class="sb sb-tertulia">TERTÚLIA</span></div>
<div class="sr"><span class="st">20:00</span><span class="si">Jantar</span><span class="sb sb-meal">REFEIÇÃO</span></div>
<div class="sr"><span class="st">22:00</span><span class="si">Atividades Noturnas</span><span class="sb sb-night">NOITE</span></div>
</div>
</div>
<div class="sch-panel" id="sch-sabado" role="tabpanel">
<p class="sch-dl">SÁBADO · 3 ABR</p>
<div class="sch-list">
<div class="sr"><span class="st">10:00</span><span class="si">Palestra + Workshops #10, #11 e #12</span><span class="sb sb-talkworkshop">PALESTRA / WORKSHOP</span></div>
<div class="sr"><span class="st">11:00</span><span class="si">Palestra</span><span class="sb sb-talk">PALESTRA</span></div>
<div class="sr"><span class="st">12:00</span><span class="si">Almoço</span><span class="sb sb-meal">REFEIÇÃO</span></div>
<div class="sr"><span class="st">14:00</span><span class="si">Palestra + Workshops #13, #14 e #15</span><span class="sb sb-talkworkshop">PALESTRA / WORKSHOP</span></div>
<div class="sr"><span class="st">15:00</span><span class="si">Palestra</span><span class="sb sb-talk">PALESTRA</span></div>
<div class="sr"><span class="st">16:30</span><span class="si">Coffee Break</span><span class="sb sb-network">NETWORKING</span></div>
<div class="sr"><span class="st">17:00</span><span class="si">Palestra</span><span class="sb sb-talk">PALESTRA</span></div>
<div class="sr"><span class="st">18:00</span><span class="si">Tertúlia</span><span class="sb sb-tertulia">TERTÚLIA</span></div>
...
<div class="sch-list">
<div class="sr"><span class="st">10:00</span><span class="si">Nascer do Sol na Praia</span><span class="sb sb-social">SOCIAL</span></div>
<div class="sr"><span class="st">12:00</span><span class="si">Almoço</span><span class="sb sb-meal">REFEIÇÃO</span></div>
<div class="sr"><span class="st">14:00</span><span class="si">Tertúlia</span><span class="sb sb-tertulia">TERTÚLIA</span></div>
<div class="sr"><span class="st">16:00</span><span class="si">Sessão de Encerramento</span><span class="sb sb-close">ENCERRAMENTO</span></div>
</div>
</div>
</div>
</div>
...
<tbody>
<tr><td><span class="tn tn-empresas">Feira de Empresas</span></td><td>Espaço de exposição para apresentação de empresas, projetos, soluções e iniciativas da área tecnológica.</td><td><span class="pp pp-empresas">Empresas &amp; Todos os participantes</span></td></tr>
<tr><td><span class="tn tn-workshop">Workshops</span></td><td>Sessões práticas de 10 a 15 pessoas com profissionais da área.</td><td><span class="pp pp-estudantes">Estudantes</span></td></tr>
<tr><td><span class="tn tn-palestra">Palestras</span></td><td>Apresentações por profissionais de empresas nacionais e internacionais.</td><td><span class="pp pp-todos">Todos os participantes</span></td></tr>
<tr><td><span class="tn tn-academico">Tertúlias Académicas</span></td><td>Conversas informais com professores da Universidade do Algarve.</td><td><span class="pp pp-estudantes">Estudantes</span></td></tr>
<tr><td><span class="tn tn-digital">Tertúlia Digital</span></td><td>Encontro com influencers da área tech.</td><td><span class="pp pp-estudantes">Estudantes</span></td></tr>
<tr><td><span class="tn tn-social">Passeio Matinal</span></td><td>Sessão de relaxamento na praia ao nascer do sol.</td><td><span class="pp pp-todos">Todos os participantes</span></td></tr>
<tr><td><span class="tn tn-ctf">CTFs</span></td><td>Competições de Capture The Flag ao longo dos dias com prémios.</td><td><span class="pp pp-todos">Todos os participantes</span></td></tr>
<tr><td><span class="tn tn-entrosamento">Atividades de Entrosamento</span></td><td>Atividades de team building e interação entre os participantes.</td><td><span class="pp pp-estudantes">Estudantes</span></td></tr>
</tbody>
</table>
</div>
</div>
...
<div class="team-ph">
<img alt="Equipa responsável pela candidatura de Faro ao ENEI 2027" class="team-photo" src="/assets/equipa.webp"/>
</div>
...
<p class="body center-t">Esta página apresenta a candidatura de Faro ao ENEI 2027. Deixa o teu nome e e-mail para mostrares interesse em ver o evento acontecer em Faro e acompanhares as novidades da candidatura.</p>
<div class="ibadges">
<span class="ibadge">Evento a 1–4 Abr 2027</span>
<span class="ibadge acc">Interesse aberto</span>
</div>
</div>
</section>
...
<p class="body">Esta página apresenta a candidatura de Faro para receber o ENEI 2027. Deixa o teu nome e e-mail para demonstrares interesse em que o evento aconteça em Faro e para acompanhares novidades sobre a proposta, o programa previsto e a evolução da candidatura.</p>
<form id="wlForm">
...
<label class="terms-consent" for="wConsent"><input id="wConsent" required="" type="checkbox"/><span>Aceito ser contactado por e-mail sobre novidades da candidatura de Faro ao ENEI 2027 e concordo com os <a data-open-docs="privacy" href="#privacy-terms">Termos de Privacidade</a>.</span></label>
...
<ul class="check-list">
<li><svg fill="none" viewbox="0 0 16 16"><circle cx="8" cy="8" r="7" stroke="#00AAFF" stroke-width="1.5"></circle><path d="M5 8.5l2 2 4-4" stroke="#00AAFF" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg>Acompanhares a evolução da candidatura de Faro</li>
<li><svg fill="none" viewbox="0 0 16 16"><circle cx="8" cy="8" r="7" stroke="#00AAFF" stroke-width="1.5"></circle><path d="M5 8.5l2 2 4-4" stroke="#00AAFF" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg>Receberes novidades sobre o programa proposto e a organização</li>
<li><svg fill="none" viewbox="0 0 16 16"><circle cx="8" cy="8" r="7" stroke="#00AAFF" stroke-width="1.5"></circle><path d="M5 8.5l2 2 4-4" stroke="#00AAFF" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg>Ajudares a mostrar que existe interesse real em trazer o ENEI a Faro</li>
<li><svg fill="none" viewbox="0 0 16 16"><circle cx="8" cy="8" r="7" stroke="#00AAFF" stroke-width="1.5"></circle><path d="M5 8.5l2 2 4-4" stroke="#00AAFF" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg>Apoiares a possibilidade de Faro receber um dos maiores eventos de Informática de Portugal</li>
</ul>
</div>
</div>
</div>
...
<div id="faqItems">
<div class="fi open" data-faqcat="candidatura"><button aria-controls="faq-a-1" aria-expanded="true" class="fq" id="faq-q-1" type="button">O que é esta candidatura?<svg class="fch" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" viewbox="0 0 20 20"><path d="M5 8l5 5 5-5"></path></svg></button><div aria-hidden="false" aria-labelledby="faq-q-1" class="fa" id="faq-a-1" role="region"><p>A candidatura de Faro ao ENEI 2027 é a proposta para trazer o Encontro Nacional de Estudantes de Informática para Faro. Esta página serve para apresentar essa proposta e recolher manifestações de interesse da comunidade.</p></div></div>
<div class="fi" data-faqcat="candidatura"><button aria-controls="faq-a-2" aria-expanded="false" class="fq" id="faq-q-2" type="button">Como posso demonstrar interesse?<svg class="fch" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" viewbox="0 0 20 20"><path d="M5 8l5 5 5-5"></path></svg></button><div aria-hidden="true" aria-labelledby="faq-q-2" class="fa" id="faq-a-2" role="region"><p>Podes deixar o teu nome e e-mail na secção "Tenho Interesse" desta página. A tua manifestação ajuda a mostrar que existe apoio da comunidade para trazer o ENEI 2027 para Faro e permite-te receber novidades sobre a candidatura.</p></div></div>
<div class="fi" data-faqcat="candidatura"><button aria-controls="faq-a-3" aria-expanded="false" class="fq" id="faq-q-3" type="button">O evento é pago?<svg class="fch" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" viewbox="0 0 20 20"><path d="M5 8l5 5 5-5"></path></svg></button><div aria-hidden="true" aria-labelledby="faq-q-3" class="fa" id="faq-a-3" role="region"><p>Se a candidatura de Faro for aprovada, os bilhetes terão preços acessíveis, com a modalidade Early Bird prevista a partir de cerca de 5 €. Ao demonstrares interesse e registares-te no website, poderás acompanhar as novidades e receber informação quando os bilhetes forem disponibilizados.</p></div></div>
